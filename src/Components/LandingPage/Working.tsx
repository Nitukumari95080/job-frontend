    ...
    <div mt-20 pb-5>
      ...
      <div className="flex px-16 justify-between items-center gap-10">
        <div className="relative">
          <img src="/woman.png" alt="Girl" className="w-[30rem]" />
          <div className="w-36 flex flex-col items-center gap-1 border border-cinnamon-300 rounded-xl py-3 px-1 backdrop-blur-md top-[15%] absolute right-0">
        ...
        <div className="flex flex-col gap-10">
          {work.map((item, index) => (
            <div key={index} className="flex items-center gap-4">
              <div className="p-2.5 bg-cinnamon-400 rounded-full">
